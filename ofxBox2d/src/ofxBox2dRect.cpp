...
//------------------------------------------------
void ofxBox2dRect::setup(b2World * b2dworld, ofRectangle rec, b2BodyType type) {
	setup(b2dworld, rec.x, rec.y, rec.width, rec.height, type);
}

//------------------------------------------------
void ofxBox2dRect::setup(b2World * b2dworld, float x, float y, float w, float h,b2BodyType type ) {
